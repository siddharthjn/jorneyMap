...
['1','Manage minimum of two projects (large, complex undertakings)','Achieving set operational objectives by contributing informaiton and recommendations to strategic plans and reviews','Proven customer leadership through client feedback','Planning Agile Project Releases and Iterations (PM109G)'],
['2','Implement cost efficient/ffective tools to address finer points of budget to gain a greater gross profit margin (Use tools like Microsoft project to build schedules and manage the plan)','Financial Management','IBM Program Work Center (IPWC)','Proven experience managing complex projects through feedback from functional managers'],
...
var pmExpertDataSet = [
['1','Manage minimum of three projects ((2) 5 & (1) 10 FTEs for 6 months). At least one projects as IBMer and within the last four years','Develop and maintain programs, tools and methods','PgMP, PMI-ACP, PMI-RMP','Evaluating based on size of the project, revenue implications, risk, customer significance, time urgency and market necessity'],
['2','Manage delivery experience leading, multiple medium to large projects over the course of the year','Develop and maintain policies that support systemic use of project management disciplines','Complete all requirements of being a project manager at experienced level','Monitoring project performance and measuring progress in terms of technical, financial and schedule performance'],
['3','Involved and engaged in all phases of project management life cycle and must have participated in concept/proposal phase.','Deploy and integrate project management discipline by project teams','Complete Basica OR Equivalent project manager curriculum (20 hours should be in the last three years)','PMP certification and continuing project management education'],
['4','Expert in financial analysis and management','Ensures projects are consistently funded, staffed and managed properly','-','At least 2 giveback instances'],
['5','-','Ensures that timely, accurate, quantitative methods are available for monitoring progress, predicting results and evaluating risk; systems are in place to support those techniques; and results are continually improved','-','Provide evidence as required by the career gramework']
];

var pmLeadDataSet = [
['1','Manage minimum of 4 projects ((2) 5, (1) 10 & (1) 20 FTEs for 6 monthsl 1 project as IBMer in the last 4 years','Participate in outside professional activities to maintain knowledge on developments in the field','Complete all training for being a project manager at Expert level. The requirements are regularly updated on Career Framework and project Management Center of Excellence','Attained 8 of 10 complexity factors spanning career and at least 1 complex project and program management experience'],
